-- Migration pour corriger le search_path de la fonction update_user_preferences_updated_at
-- Cela résout le warning de sécurité Supabase "Function Search Path Mutable"
