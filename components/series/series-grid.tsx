          ...
          >
            ...
            <div className="relative overflow-hidden rounded-md shadow-lg group-hover:shadow-xl group-hover:shadow-amber-500/20 transition-all duration-300">
              ...
              {(() => {
                ...
                const shouldUseCover = isSpecialSeries || isRiftboundSeries || isOnePieceSeries;
                const imagePosition = serie.code === 'QuestDeep' ? 'questDeep' : serie.code === 'QuestPalace' ? 'questPalace' : 'center';
                const aspectRatio = isOnePieceSeries ? 'aspect-[16/9]' : isRiftboundSeries ? 'aspect-[2.36/1]' : isPromoSeries ? 'aspect-[3.0/1]' : isQuestSeries ? 'aspect-[3.2/1]' : 'aspect-[4/1]';
                return (
